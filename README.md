...
> [!TIP]
> Make sure the desired audio device has its volume turned up in system settings.

> [!NOTE]
> If the volume parameter is not provided, sounds will play at the default volume (defined by `DEFAULT_VOLUME`)
